...
var CnxClock = /*#__PURE__*/function () {
  function CnxClock() {
    var _this = this;

    _classCallCheck(this, CnxClock);
    ...
    if (!instance) {
      ...
      setInterval(function () {
        try {
          _this._now = _this._now ? moment(_this._now).add(1, 'seconds').toDate() : null;
        } catch (e) {
...
var requiredConfigProperties = ['authority', 'client_id', 'redirect_uri', 'response_type', 'scope', 'now', 'timeInsensitive'];
